...
export default class ActionButton extends Component {
  ...
  getOverlayStyles() {
      ...
      const PlacemantMap = new Map([['up', 'flex-end'], ['down', 'flex-start'], ['center', 'center']])
    ...
    return [
      styles.overlay,
      {
        ...
        justifyContent: PlacemantMap[this.props.verticalOrientation]
      }
    ];
  }
  ...
  _renderActions() {
    const { children, verticalOrientation, zIndex } = this.props;
    ...
    const actionStyle = {
      flex: 1,
      justifyContent: PlacemantMap[verticalOrientation],
      paddingTop: verticalOrientation === "down"
        ? this.props.spacing
        : 0,
      zIndex
    };
...
ActionButton.propTypes = {
  ...
  verticalOrientation: PropTypes.oneOf(["up", "down", 'center']),
